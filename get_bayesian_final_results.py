...
from vol_predict.bayesian_from_timestamps_runner import BayesianFromTimestampsRunner
...
runner = BayesianFromTimestampsRunner(
    output_df=output_df,
...
output_df.to_csv("output_bayesian.csv")
